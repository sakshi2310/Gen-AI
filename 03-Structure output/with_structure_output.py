...
class review(TypedDict):
    summery : Annotated[str,"A bried summery of the review"]
    sentiment: Annotated[str,"return sentiment of the review either negative , positive and nureul"]
    sentiment_2: Annotated[Literal["pos","neg"],"return sentiment of the review either negative , positive and nureul"]
